...
3. Sign up or log in (use demo credentials if available)

### **2. Demo Flow: Telemetry → Alert → Service**

#### **Step 1: View Telemetry**

- Navigate to **Telemetry** page
- Select a vehicle (or create one if needed)
- Observe real-time telemetry data streaming
- Note anomaly scores and sensor readings

#### **Step 2: Trigger Alert**

- Wait for simulator to generate anomaly (or manually trigger via test endpoint)
- Navigate to **Alerts** page
- View newly generated alert with severity and diagnosis
- Check alert details and recommended actions

#### **Step 3: Create RCA (OEM Admin)**

- Log in as **OEM Admin** role
- Navigate to **RCA** page
- Create Root Cause Analysis for the alert
- Select analysis method (5 Whys, FMEA, etc.)

#### **Step 4: Create CAPA**

- Navigate to **CAPA** page
- Create Corrective/Preventive Action linked to RCA
- Assign owner team and target date

#### **Step 5: Book Service (Customer)**

- Log in as **Customer** role
- Navigate to **Service** page
- Select vehicle and service center
- Choose available time slot
- Confirm booking

#### **Step 6: Service Workflow (Service Center)**

- Log in as **Service Center** role
- View assigned bookings
- Create job card for the booking
- Add parts and labor hours
- Generate invoice
- Mark service as completed

### **3. Voice AI Demo**

1. Ensure Twilio and Deepgram are configured
2. Call the Twilio number configured in backend
3. Ask: _"What are my recent alerts?"_
4. Voice agent responds with alert information
5. Ask: _"What's the diagnosis for my vehicle?"_
6. Agent provides diagnosis details
...
- Open **Telemetry** page in multiple browser tabs
- Observe WebSocket updates in real-time
- Check **Notifications** panel for alert updates
